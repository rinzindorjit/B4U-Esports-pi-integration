    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 to-purple-900">
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold text-gray-900 mb-6 text-center">Return/Refund Policy</h1>
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              <h2 
                ...
                onClick={() => toggleSection('no-refund')}
              >
                <span>1. No Refund Policy</span>
                <span>{openSection === 'no-refund' ? '▲' : '▼'}</span>
              </h2>
              {openSection === 'no-refund' && (
            ...
            <section className="mb-8">
              ...
              >
                <span>2. Reasons for No Refund Policy</span>
                <span>{openSection === 'reasons' ? '▲' : '▼'}</span>
              </h2>
              {openSection === 'reasons' && (
                <div className="pl-4 border-l-4 border-blue-500">
                  <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              >
                <span>3. Pre-Purchase Verification</span>
            ...
            <section className="mb-8">
              ...
              >
                <span>5. Exceptional Circumstances</span>
                <span>{openSection === 'exceptions' ? '▲' : '▼'}</span>
              </h2>
            ...
            <section className="mb-8">
              ...
              >
                <span>7. How to Report Issues</span>
                <span>{openSection === 'reporting' ? '▲' : '▼'}</span>
              </h2>
            ...
            <section className="mb-8">
              <h2 
                className="text-2xl font-semibold text-gray-900 mb-4 cursor-pointer flex items-center justify-between"
                onClick={() => toggleSection('consumer-rights')}
              >
                <span>8. Consumer Rights</span>
                <span>{openSection === 'consumer-rights' ? '▲' : '▼'}</span>
              </h2>
              {openSection === 'consumer-rights' && (
                <div className="pl-4 border-l-4 border-blue-500">
                  <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              >
                <span>10. Acknowledgment</span>
                <span>{openSection === 'acknowledgment' ? '▲' : '▼'}</span>
              </h2>
              {openSection === 'acknowledgment' && (
                <div className="pl-4 border-l-4 border-blue-500">
                  <p className="text-gray-700 mb-4">
