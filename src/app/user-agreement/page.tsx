    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 to-purple-900">
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold text-gray-900 mb-6 text-center">User Agreement</h1>
          ...
          <div className="prose max-w-none">
            ...
            <section className="mb-8">
              <h2 
                className="text-2xl font-semibold text-gray-900 mb-4 cursor-pointer flex items-center justify-between"
                onClick={() => toggleSection('pi-consent')}
              >
                <span>2. Pi Network Integration Consent</span>
                <span>{openSection === 'pi-consent' ? '▲' : '▼'}</span>
              </h2>
              {openSection === 'pi-consent' && (
                <div className="pl-4 border-l-4 border-blue-500">
                  <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              <h2 
                className="text-2xl font-semibold text-gray-900 mb-4 cursor-pointer flex items-center justify-between"
                onClick={() => toggleSection('gaming-accounts')}
              >
                <span>3. Gaming Account Requirements</span>
                <span>{openSection === 'gaming-accounts' ? '▲' : '▼'}</span>
              </h2>
              {openSection === 'gaming-accounts' && (
                <div className="pl-4 border-l-4 border-blue-500">
            ...
            <section className="mb-8">
              ...
              >
                <span>4. Purchase Agreement</span>
                <span>{openSection === 'purchase' ? '▲' : '▼'}</span>
              </h2>
            ...
            <section className="mb-8">
              ...
              >
                <span>5. Data Usage and Privacy Consent</span>
                <span>{openSection === 'data-usage' ? '▲' : '▼'}</span>
              </h2>
              {openSection === 'data-usage' && (
                <div className="pl-4 border-l-4 border-blue-500">
                  <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              >
                <span>6. Testnet Operations Agreement</span>
            ...
            <section className="mb-8">
              ...
              >
                <span>7. User Conduct Agreement</span>
                <span>{openSection === 'conduct' ? '▲' : '▼'}</span>
              </h2>
              {openSection === 'conduct' && (
                <div className="pl-4 border-l-4 border-blue-500">
                  <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              >
                <span>8. Risk Acknowledgment</span>
                <span>{openSection === 'risk' ? '▲' : '▼'}</span>
              </h2>
              {openSection === 'risk' && (
                <div className="pl-4 border-l-4 border-blue-500">
                  <p className="text-gray-700 mb-4">
            ...
            <section className="mb-8">
              ...
              >
                <span>9. Support and Dispute Resolution</span>
            ...
            <section className="mb-8">
              ...
              >
                <span>10. Agreement Updates</span>
            ...
            <section className="mb-8">
              ...
              >
                <span>11. Acceptance and Electronic Signature</span>
